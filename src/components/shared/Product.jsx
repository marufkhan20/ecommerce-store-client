      ...
      <div className="border overflow-hidden relative">
        ...
        <div className="absolute -bottom-[200%] right-3 product-opt transition-all duration-500 opacity-0">
          <ul className="flex flex-col gap-1">
            ...
            <li className="inline-block p-2 text-body text-lg border bg-white rounded-bl-md rounded-br-md duration-200 transition-all hover:shadow-md cursor-pointer">
              <BsEye />
            </li>
          </ul>
        </div>
